//  Assignment 3, part 3
//  program :   This program is a collection of 20 filers required in the assignment  with a menu interface
//  to make the user choose the filter he wants and save them
//
//  Authors :
//  Name                           |      id       |      Problems
//  Ahmed Mohamed Mahmoud Ahmed    |   20230598    |  filter 3,6,9,12,15,18
//
//  Adel ahmed Mohamed El hefny    |   20230198    |  filter 2,5,8,11,14,17
//
//  Ahmed Mohamed Noureldin Ahmed  |   20230035    |  filter 1,4,7,10,13,16,19(B),20(B) 
//
//  Emails:
...
Image crop(Image image){
    cout << "Enter the from X: " << endl;
    int fromX,fromY;
    cin >> fromX;
    while(fromX < 0 || fromX >= image.width){
        cout << "Enter the from X: " << endl;
        cin >> fromX;
    }
    cout << "Enter the from Y: " << endl;
    cin >> fromY;
    while(fromY < 0 || fromY >= image.height){
        cout << "Enter the from Y: " << endl;
        cin >> fromY;
    }
